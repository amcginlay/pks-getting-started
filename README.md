...
- You installed PCF Ops Manager for PKS on GCP using [Terraforming GCP](https://github.com/pivotal-cf/terraforming-gcp) - maybe just complete the [2-step prerequsites](https://github.com/amcginlay/ops-manager-automation/blob/master/README.md#prerequisites-1) from this guide.
